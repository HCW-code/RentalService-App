        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              const ListTile(
                ...
                title: Text("전국 스키", style: TextStyle(fontWeight: FontWeight.w600),),
              ),
              SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  padding: EdgeInsets.symmetric(horizontal: 20),
                  child: SkiResort(onPressedScheduleCard : onPressedScheduleCard)
              ),
              const SizedBox(
                height: 20,
              ),
              ...
              const ListTile(
                title: Text("최근 이용 매장", style: TextStyle(fontWeight: FontWeight.w600),),
              ),
              const SizedBox(
                height: 10,
              ),
