...
class _SignInState extends State<SignIn> {
  ...
  Future<UserCredential> signInWithKaKao() async {
    ...
    final url = Uri.https('kauth.kakao.com', '/oauth/authorize', {
      ...
      'redirect_uri': 'https://fir-daffy-approval.glitch.me/callbacks/kakao/sign_in',
      //'scope': 'account_email profile',
      'state': clientState,
    });

    final result = await FlutterWebAuth.authenticate(
        url: url.toString(), callbackUrlScheme: "webauthcallback"); //"applink"//"signinwithapple"
    ...
    var response = await http.post(Uri.parse("https://fir-daffy-approval.glitch.me/callbacks/kakao/token"),
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Text("회원가입", style: TextStyle(color: Color(0xFF263238), fontWeight: FontWeight.bold),),
                  ),
                  Text('            |            ', style: TextStyle(color: Color(0xFF263238), fontWeight: FontWeight.bold),),
                  GestureDetector(
                      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => FindPassword()));},
                      child: Text("비밀번호 재설정", style: TextStyle(color: Color(0xFF263238), fontWeight: FontWeight.bold),)),
                ],
              ),
              SizedBox(height: 35,),
              divider(),
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                            ...
                            child: ImageIcon(AssetImage('images/kakao.png'))
                        ),
                      ),
                      Expanded(
                        flex: 7,
